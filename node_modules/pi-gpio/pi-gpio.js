/**
 * Taken from Rakesh Pai's pi-gpio (https://github.com/rakeshpai/pi-gpio)
 * Adjusted by Densaugeo to work with Raspberry Pi rev. 2 boards (breaks
 *   compatibility with rev 1)
 * Changes to this file are offered under the MIT license, same as the original pi-gpio
 */
...
var pinMapping = {
	"3": 2, // "3": 0 for rev 1 boards
	"5": 3, // "5": 1 for rev 1 boards
	"7": 4,
	"8": 14,
	"10": 15,
	"11": 17,
	"12": 18,
	"13": 27, // "13": 21 for rev 1 boards
	"15": 22,
	"16": 23,
	"18": 24,
	"19": 10,
